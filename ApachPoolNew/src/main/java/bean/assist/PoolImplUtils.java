...
public class PoolImplUtils {
    ...
    public static Class<?> getFactoryType(Class<? extends PooledObjectFactory> factory) {
     ...
     * 
     * @return An instance of {@link Class} representing the type used by the type parameter or an instance of {@link Integer} representing the index for the
     *         type in the definition of the defining class
     */

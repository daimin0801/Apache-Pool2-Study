...
public class DefaultPooledObject<T> implements PooledObject<T> {
	...
	private PooledObjectState state = PooledObjectState.IDLE; // @GuardedBy("this")
																// to ensure
																// transitions
																// are valid
	...
	/**
	 * Return an estimate of the last time this object was used. If the class of
	 * the pooled object implements {@link TrackedUse}, what is returned is the
	 * maximum of {@link TrackedUse#getLastUsed()} and
	 * {@link #getLastBorrowTime()}; otherwise this method gives the same value
	 * as {@link #getLastBorrowTime()}.
	 * 
	...
	/**
	 * Deallocates the object and sets it {@link PooledObjectState#IDLE IDLE} if
	 * it is currently {@link PooledObjectState#ALLOCATED ALLOCATED}.
	 * 
